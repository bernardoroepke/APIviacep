...
// Verificar se a chave "adress" está definida na sessão
if (isset($_SESSION["adress"])) {
  $adress = $_SESSION["adress"];
} else {
  // Tratar o caso em que a chave "adress" não está definida
  // Definir um valor padrão ou mostrar uma mensagem de erro, por exemplo
  $adress = null; // ou outra ação necessária
}
?>
